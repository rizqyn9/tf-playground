...
sudo bash /ops/shared/scripts/docker.sh
sudo bash /ops/shared/scripts/java-jdk.sh
sudo bash /ops/shared/scripts/cni-plugins.sh
sudo bash /ops/shared/scripts/systemd-resolver.sh